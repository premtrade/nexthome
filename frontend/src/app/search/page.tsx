...
import { formatPrice, getCompBadgeClass, getPersonaIcon, PARISHES } from '../lib/types';
    ...
    return (
        <div className="animate-fade-in">
            <div style={{ marginBottom: 28 }}>
                <h1 style={{ fontSize: 28, fontWeight: 700, marginBottom: 4 }}>Smart Search</h1>
                <p style={{ color: 'var(--color-text-muted)', fontSize: 14 }}>Search AI-enriched property listings with natural language</p>
            </div>
